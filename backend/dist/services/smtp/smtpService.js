...
class SmtpService {
    ...
    async sendSubmissionEmail(payload) {
        ...
        if (this.isMockMode) {
            logger_js_1.Logger.info(`[MOCK SMTP MODE] Simulating SMTP email delivery`, {
        ...
        try {
            ...
            logger_js_1.Logger.info(`SMTP email successfully sent`, { reference: payload.reference, messageId: info.messageId, recipient });
            return {
                success: true,
            ...
            logger_js_1.Logger.error(`SMTP email delivery failed`, { reference: payload.reference, error: err.message });
            return {
                success: false,
                error: err.message,
                mode: 'smtp',

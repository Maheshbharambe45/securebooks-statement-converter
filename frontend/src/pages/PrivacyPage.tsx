  ...
  return (
    <div className="flex-1 bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl border border-slate-200 shadow-card p-8 sm:p-12 prose prose-slate">
        ...
        <p className="text-slate-600 text-sm leading-relaxed">
          If you have questions regarding data privacy, please contact <a href="mailto:info@securebooks.co.uk" className="text-emerald-700 hover:underline">info@securebooks.co.uk</a>.
        </p>
      </div>
    </div>
  );

...
export const ContactPage: React.FC = () => {
  return (
    <div className="flex-1 bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-slate-200 shadow-card p-8 sm:p-12">
        <h1 className="text-3xl font-extrabold font-heading text-navy-900 mb-4">
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4 p-4 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Primary Email</h3>
              <a
                href="mailto:info@securebooks.co.uk"
                className="text-lg font-bold text-navy-900 hover:text-emerald-700 transition"
              >
          ...
          <div className="flex items-start space-x-4 p-4 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Website</h3>
              <a
